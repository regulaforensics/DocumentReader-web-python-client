...
class ProcessParams(object):
    ...
    openapi_types = {
        'scenario': 'Scenario'
        'result_type_output': '[Result]'
        'double_page_spread': 'bool'
        'field_types_filter': '[TextFieldType]'
        'date_format': 'str'
        'image_dpi_out_max': 'int'
        'already_cropped': 'bool'
        'custom_params': '{str: (bool, date, datetime, dict, float, int, list, str, none_type)}'
        'log': 'bool'
        'force_doc_id': 'int'
    ...
    def result_type_output(self, result_type_output):
        ...
        :type result_type_output: [Result]
        """
    ...
    def field_types_filter(self, field_types_filter):
        ...
        :type field_types_filter: [TextFieldType]
        """
    ...
    def custom_params(self, custom_params):
        ...
        :type custom_params: {str: (bool, date, datetime, dict, float, int, list, str, none_type)}
        """
