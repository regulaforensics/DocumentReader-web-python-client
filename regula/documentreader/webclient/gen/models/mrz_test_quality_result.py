...
class MRZTestQualityResult(ResultItem):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MRZTestQualityResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MRZTestQualityResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "MRZTestQuality": MRZTestQuality.from_dict(obj["MRZTestQuality"]) if obj.get("MRZTestQuality") is not None else None
        })
        return _obj
