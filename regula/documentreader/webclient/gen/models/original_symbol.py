...
class OriginalSymbol(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OriginalSymbol from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OriginalSymbol from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rect": RectangleCoordinates.from_dict(obj["rect"]) if obj.get("rect") is not None else None
        })
        return _obj
