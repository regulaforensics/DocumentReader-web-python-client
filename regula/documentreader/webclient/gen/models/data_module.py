...
class DataModule(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataModule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataModule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mData": obj.get("mData"),
            "mLength": obj.get("mLength"),
            "mReserved1": obj.get("mReserved1"),
            "mReserver2": obj.get("mReserver2"),
            "mType": obj.get("mType")
        })
        return _obj
