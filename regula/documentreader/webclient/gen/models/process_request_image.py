...
class ProcessRequestImage(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProcessRequestImage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProcessRequestImage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ImageData": ImageData.from_dict(obj["ImageData"]) if obj.get("ImageData") is not None else None,
            "light": obj.get("light"),
