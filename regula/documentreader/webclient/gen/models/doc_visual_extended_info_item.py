...
class DocVisualExtendedInfoItem(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocVisualExtendedInfoItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocVisualExtendedInfoItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "DocVisualExtendedInfo": DocVisualExtendedInfo.from_dict(obj["DocVisualExtendedInfo"]) if obj.get("DocVisualExtendedInfo") is not None else None
        })
        return _obj
