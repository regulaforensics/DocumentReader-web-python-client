...
class Result(object):
    ...
    allowable_values = [DOCUMENT_IMAGE, MRZ_TEXT, BARCODES, VISUAL_GRAPHICS, DOCUMENT_TYPE_CANDIDATES, DOCUMENT_TYPE, LEXICAL_ANALYSIS, RAW_UNCROPPED_IMAGE, VISUAL_TEXT, BARCODE_TEXT, BARCODE_GRAPHICS, AUTHENTICITY, MAGNETIC_STRIPE_TEXT_DATA, IMAGE_QUALITY, LIVE_PORTRAIT, STATUS, PORTRAIT_COMPARISON, EXT_PORTRAIT, TEXT, IMAGES, FINGERPRINTS, FINGERPRINT_COMPARISON, ENCRYPTED_RCL, LICENSE, MRZ_POSITION, BARCODE_POSITION, DOCUMENT_POSITION, RFID_RAW_DATA, RFID_TEXT, RFID_GRAPHICS, RFID_BINARY_DATA, RFID_ORIGINAL_GRAPHICS]  # noqa: E501
