...
class ListVerifiedFieldsItem(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListVerifiedFieldsItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListVerifiedFieldsItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ListVerifiedFields": ListVerifiedFields.from_dict(obj["ListVerifiedFields"]) if obj.get("ListVerifiedFields") is not None else None
        })
        return _obj
