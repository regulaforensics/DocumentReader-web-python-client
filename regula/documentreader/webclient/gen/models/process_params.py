...
class ProcessParams(BaseModel):
    ...
    double_page_spread: SkipValidation[Optional[bool]] = Field(alias="doublePageSpread", default=None, description="This option can be set to true if the image you provide contains double page spread of the passport and you want to process both pages in one go. It makes sense to use it for documents that have meaningful information on both pages. If disabled, only one page is extracted.")
