...
class OutDataTransactionImagesFieldValue(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutDataTransactionImagesFieldValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutDataTransactionImagesFieldValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "light": obj.get("light"),
            "listIdx": obj.get("listIdx"),
            "pageIdx": obj.get("pageIdx"),
            "url": obj.get("url")
        })
        return _obj
