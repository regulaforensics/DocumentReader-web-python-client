...
from regula.documentreader.webclient.ext.models import RecognitionRequest, RecognitionImage
...
with DocumentReaderApi(host) as api:
    ...
    params = ProcessParams(
        ...
        result_type_output=[Result.STATUS, Result.TEXT, Result.IMAGES, Result.AUTHENTICITY]
    )
